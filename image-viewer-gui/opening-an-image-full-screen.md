...
2. 이미지 그리드에서 원하는 **이미지 썸네일**을 클릭합니다
...
3. 고급 보기 및 분석 도구가 왼쪽 사이드바에 제공됩니다
...
이미지 위에서 마우스 커서를 이동하면 픽셀 값이 실시간으로 표시됩니다:**값 표시 위치:*** **오른쪽 색상표(LUT) 그라데이션 범례의 부동 숫자와 빨간색 선*** **더 확대 시 커서 근처 부동 값과 강조 표시된 픽셀**
