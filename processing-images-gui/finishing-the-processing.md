...
1. **메인 메뉴** <img src="../.gitbook/assets/image (1) (1) (1) (1).png" alt="" data-size="line"> 아이콘(왼쪽 상단)을 클릭하세요
...
* **희박/불건강한 식생**: 0.2 ~ 0.4
* **중간 정도 식생**: 0.4 ~ 0.6
* **건강하고 밀집된 식생**: 0.6 ~ 0.9**값이 이 범위를 벗어나는 경우:**
...
3. **보정된 워크플로우**: 과학적 정확성을 위해 반사율 이미지 사용
...
1.**QGIS, ArcGIS 또는 유사 소프트웨어로 불러오기**
...
**저장 대상:*** ✅ **원본 RAW/JPG 이미지** - 별도 드라이브/클라우드에 보관
...
7. ✅ **결과 검토** - 본 페이지**보정 및 반사율 보정이 완료된 다중 스펙트럼 이미지가 분석 준비 완료되었습니다!**
