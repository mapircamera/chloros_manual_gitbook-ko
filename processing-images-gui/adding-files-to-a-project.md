...
* 처리 중 타겟 감지 속도를 크게 향상시킵니다
* 자세한 내용은 [타겟 이미지 선택](choosing-target-images.md)을 참조하십시오

### 이미지 메타데이터 보기

테이블 상단 오른쪽 모서리의 토글 버튼을 클릭하면 선택된 이미지의 메타데이터가 이미지 그리드 영역에 표시됩니다.
...
2. **&quot;선택 항목 제거&quot;** <img src="../.gitbook/assets/image (2).png" alt="" data-size="line"> 버튼
...
* 세션당 항상 1~2개의 보정 대상 이미지를 포함하세요
* 촬영 세션 전후에 대상 이미지를 캡처하세요
