...
3. 하나 이상의 이미지 파일을 선택하세요(**Ctrl** 키를 누른 상태에서 여러 파일 선택 가능)
...
* 교정 타겟이 포함된 이미지의 경우 이 상자를 선택하십시오
* 처리 중 타겟 감지 속도를 크게 향상시킵니다
* 자세한 내용은 [타겟 이미지 선택](choosing-target-images.md) 참조
...
2. **&quot;선택 항목 제거&quot;** 버튼을 클릭합니다 <img src="../.gitbook/assets/image (2).png" alt="" data-size="line"> 버튼을 클릭하세요
...
* **카메라 모델 필터**: 여러 대의 카메라를 사용할 경우 카메라 유형별로 이미지를 그룹화***
...
1. 이미지가 중앙 미리보기 패널에 나타남
2. 확대/축소 컨트롤을 사용하여 이미지 세부 사항 확인
...
* 처리 속도 향상을 위해 대상 이미지에서 &#x27;대상&#x27; 체크박스를 사용하세요
