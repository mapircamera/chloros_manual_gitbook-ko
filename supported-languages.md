...
Chloros는 **전 세계 38개 언어**에 대한 완벽한 인터페이스 지원을 제공하여, 전 세계 사용자가 편리하게 이용할 수 있습니다. 데스크톱, 브라우저, CLI, Python 및 SDK 등 모든 인터페이스에서 즉시 언어를 전환할 수 있습니다.
...
자세한 내용은 [CLI 문서](CLI.md)를 참조하십시오.

### Chloros, Python, SDK

SDK를 초기화할 때 언어 매개변수를 설정하면 원하는 언어로 메시지와 출력을 확인할 수 있습니다.

## 지원 범위

다음 항목에서 38개 언어를 모두 완벽하게 지원합니다:

* **Chloros 데스크톱** - 완전한 GUI 번역
